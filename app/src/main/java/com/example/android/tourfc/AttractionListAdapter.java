...
class AttractionListAdapter extends ArrayAdapter<Attraction> {
    ...
    public View getView(final int position, @Nullable View convertView, @NonNull ViewGroup parent) {
        ...
        descText.setText("End Time - "+currentAttraction.getEndtime());

        // Set text for the title {@link TextView}
        TextView backerText = convertView.findViewById(R.id.list_item_backer);
        backerText.setText("Backer - "+currentAttraction.getBacker());

        // Set text for the title {@link TextView}
        TextView pledgeText = convertView.findViewById(R.id.list_item_pledge);
        int level = currentAttraction.getPledge();
        pledgeText.setText("Pledge -  $"+currentAttraction.getPledge());
    ...
    public void setFilter(ArrayList<Attraction> newList){

        mAttractions = new ArrayList<>();
        mAttractions.addAll(newList);
